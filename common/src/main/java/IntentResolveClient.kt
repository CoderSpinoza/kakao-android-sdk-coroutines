...
/**
 * @author kevin.kang. Created on 21/03/2019..
 */
class IntentResolveClient {
    fun resolveTalkIntent(context: Context, intent: Intent, minVersion: Int): Intent? {
        ...
        for (packageName in ALLOWED_PACKAGES) {
            ...
            if (packageInfo.versionCode < minVersion) continue
            if (!validateTalkSignature(packageInfo)) continue
            targetIntents.add(cloned)
            labeledIntents.add(
                    LabeledIntent(intent, info.activityInfo.applicationInfo.packageName,
        ...
        val chooserIntent = Intent.createChooser(labeledIntents.removeAt(0), context.getString(R.string.com_kakao_talk_chooser_text))
    ...
    private val RELEASE_SIGNATURE = "308201db30820144a00302010202044c707197300d06092a864886f70d010105050030" +
    ...
    private val DEBUG_SIGNATURE = "308201e53082014ea00302010202044f4ae542300d06092a864886f70d01010505003037" +
    ...
    private val ONE_RELEASE_SIGNATURE = "30820303308201eba003020102020452441f49300d06092a864886f70d01010b0" +
    ...
    private val TALK_PACKAGE_NAME = "com.kakao.talk"
    private val ONE_TALK_PACKAGE_NAME = "com.kakao.onetalk"

    private val ALLOWED_SIGNATURES = arrayOf(RELEASE_SIGNATURE, DEBUG_SIGNATURE, ONE_RELEASE_SIGNATURE)

    private val ALLOWED_PACKAGES = arrayOf(TALK_PACKAGE_NAME, ONE_TALK_PACKAGE_NAME)
}